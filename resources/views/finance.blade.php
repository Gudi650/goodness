...
<body class="bg-slate-50 text-slate-800">
    ...
    <main class="ml-0 lg:ml-64 pt-20 p-6 min-h-screen">
        <div class="mb-6"><h1 class="text-2xl font-semibold">Finance</h1><p class="text-sm text-slate-500">Invoices, expenses and payments</p></div>
        <div class="bg-white border border-slate-200 rounded-lg p-4">
            <div class="flex gap-2 mb-4"><button id="tabInvoices" class="px-3 py-2 bg-green-50 text-green-700 rounded-md">Invoices</button><button id="tabExpenses" class="px-3 py-2 text-slate-600 rounded-md">Expenses</button><button id="tabPayments" class="px-3 py-2 text-slate-600 rounded-md">Payments</button></div>
