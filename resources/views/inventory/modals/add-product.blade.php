            ...
            <div class="px-6 py-5 space-y-6 max-h-[calc(100vh-240px)] overflow-y-auto">
                ...
                <div class="border-b border-slate-200 pb-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="brand" placeholder="e.g., Bosch Industrial"
                                class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent">
                        </div>
                        <div>
                ...
                <div class="border-b border-slate-200 pb-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="last_restocked_date"
                                class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent">
                        </div>
                ...
                <div class="border-b border-slate-200 pb-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="profit_margin" placeholder="Auto-calculated" disabled
                                class="w-full px-3 py-2 border border-slate-300 rounded-md bg-slate-50 text-slate-600">
                ...
                <div class="pb-4">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="product_description" placeholder="Enter detailed product description..." rows="3"
