<div id="addExpenseModal" class="hidden">
    <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4" onsubmit="showExpenseCreateLoader()">
        ...
        <section class="rounded-lg border border-slate-100 bg-white p-4 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="expenseId" name="expense_number" readonly placeholder="EXP-0001" class="w-full cursor-not-allowed rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-slate-500">
                </div>
                <div>
                    <label class="mb-1 block text-sm font-medium text-slate-700">Expense Date</label>
                    <input type="date" id="expenseDate" name="expense_date" required class="w-full rounded-md border border-slate-200 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-brand-500">
                </div>
                <div>
                ...
                <div>
                    ...
                    <select id="expenseDepartment" name="department_id" required class="w-full rounded-md border border-slate-200 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-brand-500">
        ...
        <section class="rounded-lg border border-slate-100 bg-white p-4 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    ...
                    <select id="expenseCategory" name="category" required class="w-full rounded-md border border-slate-200 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-brand-500">
                ...
                <div>
                    ...
                    <select id="expenseSubCategory" name="sub_category" class="w-full rounded-md border border-slate-200 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-brand-500">
                        <option value="">Select sub-category...</option>
                    </select>
                </div>
                <div>
                    <label class="mb-1 block text-sm font-medium text-slate-700">Payment Method</label>
                    <select id="expensePaymentMethod" name="payment_method" required class="w-full rounded-md border border-slate-200 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-brand-500">
                ...
                <div>
                    ...
                    <input type="text" id="expenseReference" name="reference_number" placeholder="Receipt / Cheque / M-Pesa Txn ID" class="w-full rounded-md border border-slate-200 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-brand-500">
                </div>
            </div>
        </section>
        ...
        <section class="rounded-lg border border-slate-100 bg-white p-4 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    ...
                    <input type="number" id="expenseAmount" name="amount" min="0" step="0.01" required placeholder="0.00" class="w-full rounded-md border border-slate-200 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-brand-500">
                </div>
                <div class="flex items-center justify-between rounded-md border border-slate-100 bg-slate-50 px-3 py-2">
                    ...
                    <label class="inline-flex cursor-pointer items-center">
                        ...
                        <input id="expenseVatIncluded" name="vat_included" value="1" type="checkbox" class="peer sr-only">
                ...
                <div id="expenseVatRateWrap" class="hidden">
                    ...
                    <input type="number" id="expenseVatRate" name="vat_rate" min="0" step="0.01" value="18" class="w-full rounded-md border border-slate-200 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-brand-500">
                </div>
                <div id="expenseVatAmountWrap" class="hidden">
                    ...
                    <input type="text" id="expenseVatAmount" name="vat_amount" readonly value="0.00" class="w-full rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-slate-700">
                </div>
                <div class="md:col-span-2">
                    <label class="mb-1 block text-sm font-medium text-slate-700">Net Amount</label>
                    <input type="text" id="expenseNetAmount" name="net_amount" readonly value="0.00" class="w-full rounded-md border border-slate-200 bg-slate-50 px-3 py-2 font-semibold text-slate-700">
                </div>
            </div>
        </section>
        ...
        <div class="flex flex-col gap-2 border-t border-slate-100 pt-2 sm:flex-row sm:justify-end">
            ...
            <button type="submit" name="submit_mode" value="draft" class="rounded-md border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50">Save as Draft</button>
